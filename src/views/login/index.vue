      ...
      <div class="login-intro min-w-[720px] flex-col-cs">
        ...
        <div class="captcha-list flex-col-as gap-9 mt-9">
          ...
          >
            ...
            <div class="ml-5">
              <p class="text-white text-2xl">{{ item.title }}</p>
              <p
                v-if="item.dec !== ''"
                class="text-custom-norText text-lg mt-3"
              >
                {{ item.dec }}
              </p>
            </div>
